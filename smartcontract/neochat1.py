...
def Main(operation, args):
    ...
    """
    Log("test")
    Notify(concat("args: ",len(args)))
    Notify(concat("operation: ",operation))
    Notify(concat("args1: ",args[0]))
    Notify(concat("args2: ",args[1]))
    Notify(concat("args3: ",args[2]))
    Notify(concat("args4: ",args[3]))
